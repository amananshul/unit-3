...
function myScope(){
    ...
    scopeval.map(function(elem,index){
        ...
        p4.innerText=elem.p4
        var p5 = document.createElement("li")
        p5.innerText=elem.p5
...
function myprototype(){
    ...
    document.querySelector("#container").innerText=null
    prototypeval.map(function(elem,index){
        var div=document.createElement("ul")
        var p1 = document.createElement("li")
        p1.innerText=elem.p1
        var p2 = document.createElement("li")
...
function myconstructor(){
    ...
    constructorval.map(function(elem,index){
        var div=document.createElement("ul")
        var p1 = document.createElement("li")
        p1.innerText=elem.p1
        var p2 = document.createElement("li")
...
function myhoisting(){
    ...
    hoistingval.map(function(elem,index){
        var div=document.createElement("ul")
        var p1 = document.createElement("li")
        p1.innerText=elem.p1
        var p2 = document.createElement("li")
